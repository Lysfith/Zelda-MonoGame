...
namespace Zelda.Core.Data.Managers
{
    public class ManagerCamera
    {
        ...
        {
            return ((vector.X > _position.X - Tile.Width && vector.X < _position.X + 160 + Tile.Width)
                && (vector.Y > _position.Y - Tile.Height && vector.Y < _position.Y + 160 + Tile.Height));
        }

        public Vector2 WorlToScreenPosition(Vector2 position)
        {
